...
{
\footnotesize \textit{Prepared as a comprehensive framework synthesizing IDAI700 (Ethics of Artificial Intelligence), ED415 (Adolescent Development), and my ED415 Research Brief on equitable diagnostic tools for culturally and linguistically diverse (CLD) adolescents} \\

\vspace{0.3cm}

\textit{\tiny\textbf{Academic Integration Statement:} This paper integrates seven authoritative sources organized through my IDAI700 Research Portfolio: Nadarzynski et al. (2024) on co-design as origin of trust; Lekadir et al. (2025) on governance infrastructure; my application of Resistance Mapping for civic literacy; Sagona et al. (2025) on trust as measurable outcome; Marko et al. (2025) on empirical disparities; Chen et al. (2023) on translating ethics into engineering; and Luke Munn's IDAI700 critique of toothless ethics theater. The Garcia ED415 Research Brief (2025) serves as both the quantitative backbone proving harm and the empirical evidence that synthesizes how these six peer-reviewed papers operationalize justice for CLD adolescents. EQUITAS demonstrates that enforceable equity demands simultaneous transformation across epistemic authority (whose knowledge counts), procedural justice (who decides), and distributive justice (who bears harm and benefits).}
}
...
The framework integrates seven sources: Six peer-reviewed papers documenting the evidence chain—Nadarzynski et al. (2024) demonstrate that co-design is the origin of trust; Lekadir et al. (2025) specify how governance infrastructure makes practices auditable; Chen et al. (2023) prove that fairness is technically achievable and operationalizable; Sagona et al. (2025) clarify that trust is an engineered outcome requiring measurable practices; Marko et al. (2025) document that disparities are structural and reproducible; and Luke Munn (IDAI700) emphasizes that ethics without enforcement become meaningless and toothless theater. Synthesized through and grounded in my Garcia ED415 Research Brief (2025), which provides the quantitative proof of harm and empirical validation of how these papers operationalize justice, these sources converge on a powerful insight: trustworthy, equitable diagnostic AI requires simultaneous transformation across design, governance, measurement, and power-sharing—and no single dimension alone is sufficient.

\vspace{0.5em}

The central thesis is that diagnostic AI must be treated as a justice-critical institution with enforceable equity requirements, not optional enhancements. If documented diagnostic harm concentrates in CLD populations—a reality my ED415 research confirms through analysis of ADHD and depression underdiagnosis rates in Latino adolescents—and those populations carry historical legacies of medical neglect and racialized dismissal, then precaution is not perfectionism—it is a basic safety stance. EQUITAS operationalizes this principle through explicit performance thresholds (equalized-odds gaps $\leq 3\%$, true-positive-rate ratios $0.9$--$1.1$), mandatory community veto authority, continuous monitoring with automatic escalation and suspension protocols, and public harm ledgers that document where benefits and harms fall. The call to action is not simply ``build fairer models.'' It is to change who gets to decide what ``fair'' means and what happens when fairness fails.
...
Existing AI ethics frameworks fail to prevent these harms because they remain what Luke Munn calls ``meaningless, isolated, and toothless''—they articulate high-level principles about fairness and engagement but lack binding thresholds, enforcement mechanisms, or mechanisms that grant communities veto power.\cite{munn_idai700} This allows institutions to claim compliance with equity language while continuing to deploy and iterate on diagnostic systems that underdiagnose CLD adolescents.

\subsection{Why Principles Without Enforcement Become Ethics Theater}

Munn's critique is not academic. It is operational. When a healthcare organization commits to ``ensuring fairness'' without specifying what fair performance means, how it will be measured, what constitutes an unacceptable threshold, or what happens when that threshold is violated, ``fairness'' becomes rhetorical cover for continuity in unjust practice.\cite{munn_idai700} This dynamic is intensified in healthcare by utilitarian pressure to deploy ``good enough'' systems quickly, often treating higher error rates in marginalized populations as acceptable collateral.\cite{munn_idai700}

EQUITAS begins from an opposite principle: if documented diagnostic harm concentrates in a specific population, and that population carries historical legacies of medical neglect and racialized dismissal, then precaution is not perfectionism—it is a basic safety stance consistent with responsible governance.\cite{garcia_ed415}
...
\begin{enumerate}
    ...
    \item \textit{Civic Literacy via Digital Resistance Mapping}, a pedagogical approach that prepares CLD communities to read, interpret, contest, and reshape diagnostic technologies rather than remaining passive recipients of algorithmic decisions.\cite{garcia_ed415}
\end{enumerate}
...
The thesis is this: \textbf{trustworthy diagnostic AI for CLD adolescents is impossible without simultaneous transformation of both technical systems and governance institutions}. If an algorithm achieves excellent overall accuracy while systematically underdiagnosing depression in Spanish-dominant youth or ADHD in girls of color, it is not technically sound and ethically acceptable—it is unsafe.\cite{marko2025} Conversely, if institutional processes are ``fair'' and participatory but communities lack enforceable authority to stop harmful deployments, those processes function as democracy theater while preserving the power asymmetries that perpetuate harm.\cite{munn_idai700}
...
%==============================================================================
\section{Background: Synthesis of Seven Foundation Sources}
%==============================================================================

\subsection{The Quantitative Backbone: Garcia ED415 Research Brief (2025)---Proof of Harm}

Before examining how systems should be designed, we must establish that harm is real, measured, and reproducible. My ED415 Research Brief provides this quantitative foundation. Through systematic analysis of adolescent diagnostic data, the brief documents that Latino adolescents experience ADHD and depression underdiagnosis at rates 40--50\% lower than white peers despite equal or higher symptom burdens, longer diagnostic delays, and less comprehensive follow-up care.\cite{garcia_ed415} This is not anecdote; it is patterned institutional failure. The brief establishes that diagnostic inequity is not incidental but structural, caused by screening tools developed on majority-culture populations, evaluation regimes that hide subgroup disparities through aggregate metrics, and institutional incentive systems that tolerate disparate harm.\cite{garcia_ed415}

Critically, the brief serves a dual function in EQUITAS. It is the \textit{proof of harm} that makes the case for urgent reform mandatory, not optional. It is also the \textit{empirical synthesis} that shows how the six peer-reviewed papers---when integrated---operationalize justice for the exact adolescents documented to be harmed. The brief demonstrates that Nadarzynski's co-design principles, Lekadir's governance infrastructure, Chen's fairness metrics, Sagona's trust indicators, and Marko's empirical documentation of disparities are not theoretical—they are responses to the specific harms documented in real data.\cite{garcia_ed415}
...
However, Nadarzynski et al.'s framework, while powerful, does not fully address the power dynamics that EQUITAS must confront. Co-design grounded in genuine participation can still occur within institutional hierarchies where final decision authority remains with organizations that have incentives to minimize cost, accelerate deployment, or limit liability. EQUITAS therefore takes Nadarzynski's participatory lifecycle as necessary but upgrades it: co-design is only legitimate when marginalized communities hold \textbf{binding authority}—not merely consultative input—over what the system is for, what data it uses, and what happens when it causes documented harm.\cite{nadarzynski2024}
...
\subsection{Ethics Skepticism: Luke Munn (IDAI700) on Toothless Principles}

Luke Munn's IDAI700 critique sharps the ethical stakes: prevailing AI ethics frameworks often fail because they lack enforcement mechanisms, allowing institutions to claim virtue while continuing business as usual.\cite{munn_idai700} When an organization publishes a fairness statement without binding thresholds, monitoring timelines, or community veto authority, ethics becomes theater—persuasive language that obscures continuity in unjust practice.\cite{munn_idai700}

Munn's skepticism is crucial for EQUITAS because it explains why good intentions fail. Chen et al. provide technical knowledge about how to build fairer algorithms. Lekadir et al. specify governance best practices. Sagona et al. measure trust. But without enforcement mechanisms that shift authority toward those most affected, these insights become isolated best practices adopted voluntarily by well-intentioned institutions while harmful systems continue elsewhere.\cite{munn_idai700}

EQUITAS responds to Munn's critique by making enforcement non-optional: binding Community Advisory Board veto authority, automatic escalation when fairness thresholds are exceeded, public harm ledgers documenting where benefits and harms fall, and documented remediation timelines with community authority to block reactivation if harm persists.\cite{munn_idai700}

\subsection{Critical Synthesis: Seven Sources Converge on Enforceable Equity}

\begin{tcolorbox}[colback=noteback,colframe=noteborder,title=\textbf{The Convergence: From Harm to Systems Change}]
These seven sources—six peer-reviewed papers and one research brief—tell a unified story validated by empirical proof of harm.
...
Nadarzynski et al. show \textit{who} must participate: marginalized communities as co-designers with binding authority, not consultants.\cite{nadarzynski2024}

Lekadir et al. specify \textit{how} institutions must operate: through auditable governance infrastructure with documented practices at every lifecycle stage.\cite{lekadir2025}

Chen et al. provide \textit{the technical tools}: fairness metrics, mitigation strategies, and monitoring protocols that translate ethics into engineering.\cite{chen2023}

Sagona et al. define \textit{the outcome}: trust as a measurable result of transparent practices and accountability, earned not demanded.\cite{sagona2025}

Marko et al. prove \textit{the scale}: systematic review of 129 systems showing these disparities are patterned, not exceptional, and remedies are known but unenforced.\cite{marko2025}

Munn warns that without enforcement, all of this becomes theater. \cite{munn_idai700}

Together, these seven sources form EQUITAS: equity through co-design + governance + metrics + enforcement + lived expertise.
\end{tcolorbox}
...
EQUITAS is also responsive to power analysis: it explicitly treats trust, fairness, and equity as outcomes requiring institutional power-sharing.\cite{munn_idai700} By embedding CAB veto rights, binding metric thresholds, enforceable monitoring, and civic-literacy programs that prepare communities to exercise governance authority, EQUITAS treats equity not as a value to pursue but as a safety requirement that must be enforced.\cite{lekadir2025}
...
A compelling objection comes from pragmatic utilitarian perspective: EQUITAS is too expensive, too slow, and too burdensome for resource-constrained healthcare systems.\cite{munn_idai700} Requiring Community Advisory Boards with veto power, extensive subgroup validation, continuous fairness auditing, and community literacy programs will substantially delay deployment of diagnostic AI tools that could benefit the majority now. If a new depression screener could markedly improve outcomes for 80--85\% of adolescents immediately, requiring years of co-design, validation, and governance-structure establishment might produce net harm by denying timely support to thousands of youth.\cite{munn_idai700}
...
The utilitarian objection does surface real tensions: healthcare systems operate under genuine resource scarcity, and adolescent mental-health crises demand urgent response.\cite{munn_idai700} EQUITAS treats resource constraints as a governance problem rather than an excuse to normalize predictable injustice.
...
This paper has argued that existing AI ethics frameworks fail because they do not bind institutions to equity outcomes or grant communities enforceable authority. EQUITAS responds by integrating seven authoritative sources into coherent governance architecture: My ED415 Research Brief providing quantitative proof of harm and empirical synthesis; co-design as origin of trust (Nadarzynski et al., 2024), governance as auditable infrastructure (Lekadir et al., 2025), trust as measurable outcome (Sagona et al., 2025), empirical evidence of disparities (Marko et al., 2025), ethics-to-engineering translation (Chen et al., 2023), and ethics skepticism as call to enforcement (Munn, IDAI700).\cite{garcia_ed415}\cite{nadarzynski2024}\cite{lekadir2025}\cite{sagona2025}\cite{marko2025}\cite{chen2023}\cite{munn_idai700}
...
The central limitation encountered was that AI can make justice language sound fluent while quietly smoothing over power conflicts that are actually at stake. This risk mirrors what Munn critiques as ethics-washing: persuasive abstraction appearing complete while remaining unenforceable.\cite{munn_idai700} To counteract this tendency, I treated my lived experience, research brief, and IDAI700 materials as non-negotiable constraints: every time prose drifted toward generic equity language, I forced it back into specific mechanisms (authority, veto, thresholds, monitoring, redress). This discipline prevented AI from smoothing away the power asymmetries that EQUITAS is designed to expose.\cite{garcia_ed415}
