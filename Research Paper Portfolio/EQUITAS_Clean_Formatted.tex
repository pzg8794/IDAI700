...
\definecolor{questionbg}{RGB}{235, 245, 255}
\definecolor{questionborder}{RGB}{0, 102, 204}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} What's your topic?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} Why does it have important ethical dimensions?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} What's the main ethical position you will advance?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} What do the scholarly sources in your research portfolio say about this issue?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} What's your take on their positions?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} How have these articles informed your understanding of the ethical dimensions?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} In full detail, what's your ethical argument?]
\end{tcolorbox}

\subsection{The Problem: Diagnostic Disparity as Systemic Injustice}
...
\subsection{The Framework: Three Pillars of Enforceable Equity}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} Identify and respond to the strongest objection to your ethical position]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} Sum up your position]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{GUIDING QUESTION:} Clarify its practical implications for individuals and society]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{REFLECTION QUESTION:} How specifically did you use AI?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{REFLECTION QUESTION:} What did you learn about AI's abilities and limitations?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{REFLECTION QUESTION:} Does your experience using AI connect to the ethical issues you researched?]
\end{tcolorbox}
...
\begin{tcolorbox}[colback=questionbg,colframe=questionborder,title=\textbf{REFLECTION QUESTION:} Did this experience change your perspective on AI ethics?]
\end{tcolorbox}
