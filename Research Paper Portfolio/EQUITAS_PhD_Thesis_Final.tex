...
\textit{\tiny\textbf{Academic Integration Statement:} This paper bridges six foundational sources---Nadarzynski et al. (2024), Lekadir et al. (2025), Chen et al. (2023), Sagona et al. (2025), Marko et al. (2025), and Luke Munn's IDAI700 critique of toothless ethics---into a coherent governance architecture. It grounds every claim in lived experience of diagnostic harm and demonstrates that enforceable equity demands simultaneous transformation across epistemic authority (whose knowledge counts), procedural justice (who decides), and distributive justice (who bears harm and benefits). EQUITAS operationalizes justice through community co-design with binding veto power, governance with measurable thresholds and enforcement mechanisms, and civic literacy that prepares communities to act as algorithm auditors rather than passive subjects.}
}
...
The framework deliberately incorporates trust as a measurable outcome \cite{sagona2025} and grounds itself in empirical evidence of documented disparities \cite{marko2025} rather than treating equity as an aspirational value.
...
%==============================================================================
\section{Background: Synthesis of Six Foundation Sources}
%==============================================================================
...
Marko et al. also identify a crucial gap: disparities are well-documented, remedies are widely recommended, yet institutions continue deploying systems that perpetuate harm.\cite{marko2025} This gap is where EQUITAS intervenes. Documenting harm is necessary but insufficient; what is required is governance infrastructure with enforceable authority to mandate inclusion and stop deployment when documented evidence shows that CLD subgroups will be harmed.

\subsection{Critical Synthesis: Convergence on Enforceable Equity}

\begin{tcolorbox}[colback=noteback,colframe=noteborder,title=\textbf{The Convergence}]
These five sources, synthesized through my ED415 research, converge on a singular insight: \textbf{trustworthy, equitable diagnostic AI requires simultaneous transformation across four dimensions—design, governance, measurement, and power-sharing—and no single dimension alone is sufficient.}

Nadarzynski et al. establish that co-design is foundational but does not guarantee authority.\cite{nadarzynski2024} Lekadir et al. demonstrate that governance infrastructure can specify practices but cannot enforce accountability without external oversight.\cite{lekadir2025} Chen et al. show that technical fairness is achievable but requires deliberate policy choices.\cite{chen2023} Sagona et al. clarify that trust is earned through observable practices, not asserted through rhetoric.\cite{sagona2025} Marko et al. provide empirical evidence that disparities are structural, not incidental.\cite{marko2025} Munn adds that principles without teeth become ethics theater.\cite{munn_idai700}

The tension that EQUITAS must resolve: participation without authority risks tokenism; governance without enforcement risks capture by institutional interests; metrics without contestability risk becoming quantified discrimination; and practices without power-sharing risk reproducing the hierarchies they claim to address.\cite{munn_idai700}
\end{tcolorbox}
...
Diagnostic systems are not neutral tools; they are institutions that shape who is seen, who is believed, and who receives care. For CLD adolescents living at intersections of ADHD, chronic illness, depression, and childhood trauma, diagnostic accuracy is not an academic question—it is a matter of identity, educational opportunity, and self-understanding. When diagnostic systems systematically fail to recognize these adolescents, they institutionalize epistemic injustice, procedural exclusion, and distributive harm.\cite{garcia_ed415}

This paper has argued that existing AI ethics frameworks fail because they do not bind institutions to equity outcomes or grant communities enforceable authority. EQUITAS responds by integrating six foundational sources into coherent governance architecture: co-design as origin of trust (Nadarzynski et al., 2024), governance as auditable infrastructure (Lekadir et al., 2025), trust as measurable outcome (Sagona et al., 2025), empirical evidence of disparities (Marko et al., 2025), ethics-to-engineering translation (Chen et al., 2023), and resistance mapping as civic literacy (Garcia, 2025).\cite{nadarzynski2024}\cite{lekadir2025}\cite{sagona2025}\cite{marko2025}\cite{chen2023}\cite{garcia_ed415} The framework integrates Munn's skepticism about ethics theater, insisting that principles without enforcement become tools for institutional self-protection rather than genuine equity.\cite{munn_idai700}
